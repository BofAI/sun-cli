...
# SunPump Swap can also used this，such as：
sun swap TRX MEME_TOKEN_ADDRESS <TRX_Amount> --slippage 0.005

or

sun swap MEME_TOKEN_ADDRESS TRX  <MEME_TOKEN_Amount> --slippage 0.005
